...
Interpreting SLOC metrics is always problematic and the issue of what is the right level of \emph{``verbosity''} in a language is complex and should not be reduced naively to just counting SLOC.
